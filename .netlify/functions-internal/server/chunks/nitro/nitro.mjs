...
import H$1 from 'react-dom/server';
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/joe.barnett/dev/personal/basic-auth","order":0,"outDir":"/Users/joe.barnett/dev/personal/basic-auth/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/joe.barnett/dev/personal/basic-auth","outDir":"/Users/joe.barnett/dev/personal/basic-auth/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/joe.barnett/dev/personal/basic-auth","base":"/","outDir":"/Users/joe.barnett/dev/personal/basic-auth/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start-server-functions-handler/dist/esm/index.js","root":"/Users/joe.barnett/dev/personal/basic-auth","outDir":"/Users/joe.barnett/dev/personal/basic-auth/.vinxi/build/server","order":3}],"server":{"preset":"netlify","experimental":{"asyncContext":true}},"root":"/Users/joe.barnett/dev/personal/basic-auth"};
				const buildManifest = {"client":{"/Users/joe.barnett/dev/personal/basic-auth/app/styles/app.css":{"file":"assets/app-DsP6hc0w.css","src":"/Users/joe.barnett/dev/personal/basic-auth/app/styles/app.css"},"_client-DgwULqby.js":{"file":"assets/client-DgwULqby.js","name":"client","dynamicImports":["app/routes/signup.tsx?tsr-split","app/routes/logout.tsx?tsr-split","app/routes/login.tsx?tsr-split","app/routes/index.tsx?tsr-split","app/routes/_authed/posts.tsx?tsr-split","app/routes/_authed/posts.tsx?tsr-split","app/routes/_authed/posts.index.tsx?tsr-split","app/routes/_authed/posts.$postId.tsx?tsr-split","app/routes/_authed/posts.$postId.tsx?tsr-split"],"assets":["assets/app-DsP6hc0w.css"]},"_posts-Dr3c42Io.js":{"file":"assets/posts-Dr3c42Io.js","name":"posts","imports":["_client-DgwULqby.js"]},"app/routes/_authed/posts.$postId.tsx?tsr-split":{"file":"assets/posts._postId-C6tECjjP.js","name":"posts._postId","src":"app/routes/_authed/posts.$postId.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-DgwULqby.js","_posts-Dr3c42Io.js"]},"app/routes/_authed/posts.index.tsx?tsr-split":{"file":"assets/posts.index-CXc8vcI4.js","name":"posts.index","src":"app/routes/_authed/posts.index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-DgwULqby.js"]},"app/routes/_authed/posts.tsx?tsr-split":{"file":"assets/posts-BRJ0x6AE.js","name":"posts","src":"app/routes/_authed/posts.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-DgwULqby.js","_posts-Dr3c42Io.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-B5938LnN.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-DgwULqby.js"]},"app/routes/login.tsx?tsr-split":{"file":"assets/login-b-xO12h_.js","name":"login","src":"app/routes/login.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-DgwULqby.js"]},"app/routes/logout.tsx?tsr-split":{"file":"assets/logout-DTkCCFM-.js","name":"logout","src":"app/routes/logout.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-DgwULqby.js"]},"app/routes/signup.tsx?tsr-split":{"file":"assets/signup-BD8dZwF3.js","name":"signup","src":"app/routes/signup.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-DgwULqby.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-CwqYvT_U.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-DgwULqby.js"]}},"ssr":{"/Users/joe.barnett/dev/personal/basic-auth/app/styles/app.css":{"file":"assets/app-DsP6hc0w.css","src":"/Users/joe.barnett/dev/personal/basic-auth/app/styles/app.css"},"_posts-Cssr0xTt.js":{"file":"assets/posts-Cssr0xTt.js","name":"posts","imports":["_ssr-C1wXMKN1.js"]},"_ssr-C1wXMKN1.js":{"file":"assets/ssr-C1wXMKN1.js","name":"ssr","dynamicImports":["app/routes/signup.tsx?tsr-split","app/routes/logout.tsx?tsr-split","app/routes/login.tsx?tsr-split","app/routes/index.tsx?tsr-split","app/routes/_authed/posts.tsx?tsr-split","app/routes/_authed/posts.tsx?tsr-split","app/routes/_authed/posts.index.tsx?tsr-split","app/routes/_authed/posts.$postId.tsx?tsr-split","app/routes/_authed/posts.$postId.tsx?tsr-split"],"assets":["assets/app-DsP6hc0w.css"]},"app/routes/_authed/posts.$postId.tsx?tsr-split":{"file":"assets/posts._postId-DekZoZAw.js","name":"posts._postId","src":"app/routes/_authed/posts.$postId.tsx?tsr-split","isDynamicEntry":true,"imports":["_posts-Cssr0xTt.js","_ssr-C1wXMKN1.js"]},"app/routes/_authed/posts.index.tsx?tsr-split":{"file":"assets/posts.index-GrcD0GTd.js","name":"posts.index","src":"app/routes/_authed/posts.index.tsx?tsr-split","isDynamicEntry":true},"app/routes/_authed/posts.tsx?tsr-split":{"file":"assets/posts--TqO-k-0.js","name":"posts","src":"app/routes/_authed/posts.tsx?tsr-split","isDynamicEntry":true,"imports":["_posts-Cssr0xTt.js","_ssr-C1wXMKN1.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-CuMTP0jl.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true},"app/routes/login.tsx?tsr-split":{"file":"assets/login-0uWw0H6G.js","name":"login","src":"app/routes/login.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-C1wXMKN1.js"]},"app/routes/logout.tsx?tsr-split":{"file":"assets/logout-EquEDiL3.js","name":"logout","src":"app/routes/logout.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-C1wXMKN1.js"]},"app/routes/signup.tsx?tsr-split":{"file":"assets/signup-CfKMAOQ9.js","name":"signup","src":"app/routes/signup.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-C1wXMKN1.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-C1wXMKN1.js"]}},"server":{"/Users/joe.barnett/dev/personal/basic-auth/app/styles/app.css":{"file":"assets/app-DsP6hc0w.css","src":"/Users/joe.barnett/dev/personal/basic-auth/app/styles/app.css"},"_index-zE0fNPw6.js":{"file":"assets/index-zE0fNPw6.js","name":"index","imports":["_server-Bvpj6q62.js"]},"_prisma-y_Uazyjg.js":{"file":"assets/prisma-y_Uazyjg.js","name":"prisma"},"_server-Bvpj6q62.js":{"file":"assets/server-Bvpj6q62.js","name":"server","dynamicImports":["app/routes/__root.tsx?tsr-directive-use-server=","app/routes/signup.tsx?tsr-directive-use-server=","app/routes/_authed.tsx?tsr-directive-use-server=","app/routes/logout.tsx?tsr-split=&tsr-directive-use-server=","app/utils/posts.ts?tsr-directive-use-server=","app/utils/posts.ts?tsr-directive-use-server="]},"_session-lOfsFNRv.js":{"file":"assets/session-lOfsFNRv.js","name":"session","imports":["_server-Bvpj6q62.js"]},"app/routes/__root.tsx?tsr-directive-use-server=":{"file":"assets/__root-BvkRr39_.js","name":"__root","src":"app/routes/__root.tsx?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_session-lOfsFNRv.js","_index-zE0fNPw6.js","_server-Bvpj6q62.js"],"assets":["assets/app-DsP6hc0w.css"]},"app/routes/_authed.tsx?tsr-directive-use-server=":{"file":"assets/_authed-DjZlbL7q.js","name":"_authed","src":"app/routes/_authed.tsx?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_prisma-y_Uazyjg.js","_session-lOfsFNRv.js","_index-zE0fNPw6.js","_server-Bvpj6q62.js"]},"app/routes/logout.tsx?tsr-split=&tsr-directive-use-server=":{"file":"assets/logout-CNxee-Uy.js","name":"logout","src":"app/routes/logout.tsx?tsr-split=&tsr-directive-use-server=","isDynamicEntry":true,"imports":["_session-lOfsFNRv.js","_index-zE0fNPw6.js","_server-Bvpj6q62.js"]},"app/routes/signup.tsx?tsr-directive-use-server=":{"file":"assets/signup-Ds5DQt_1.js","name":"signup","src":"app/routes/signup.tsx?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_prisma-y_Uazyjg.js","_session-lOfsFNRv.js","_index-zE0fNPw6.js","_server-Bvpj6q62.js"],"dynamicImports":["app/routes/signup.tsx?tsr-split"]},"app/routes/signup.tsx?tsr-split":{"file":"assets/signup-MdmJsJON.js","name":"signup","src":"app/routes/signup.tsx?tsr-split","isDynamicEntry":true,"imports":["_prisma-y_Uazyjg.js","_session-lOfsFNRv.js","_index-zE0fNPw6.js","_server-Bvpj6q62.js"]},"app/utils/posts.ts?tsr-directive-use-server=":{"file":"assets/posts-CQVEsRfk.js","name":"posts","src":"app/utils/posts.ts?tsr-directive-use-server=","isDynamicEntry":true,"imports":["_index-zE0fNPw6.js","_server-Bvpj6q62.js"]},"virtual:$vinxi/handler/server":{"file":"server.js","name":"server","src":"virtual:$vinxi/handler/server","isEntry":true,"imports":["_server-Bvpj6q62.js"]}}};
...
const f = { stringify: (e) => JSON.stringify(e, function(n, r) {
  const o = this[n], c = h.find((a) => a.stringifyCondition(o));
...
} }, l = (e, t, n, r) => ({ key: e, stringifyCondition: t, stringify: (o) => ({ [`$${e}`]: n(o) }), parseCondition: (o) => Object.hasOwn(o, `$${e}`), parse: (o) => r(o[`$${e}`]) }), h = [l("undefined", (e) => e === undefined, () => 0, () => {
}), l("date", (e) => e instanceof Date, (e) => e.toISOString(), (e) => new Date(e)), l("error", (e) => e instanceof Error, (e) => ({ ...e, message: e.message, stack: undefined, cause: e.cause }), (e) => Object.assign(new Error(e.message), e)), l("formData", (e) => e instanceof FormData, (e) => {
  const t = {};
  return e.forEach((n, r) => {
    const o = t[r];
    o !== undefined ? Array.isArray(o) ? o.push(n) : t[r] = [o, n] : t[r] = n;
  }), t;
}, (e) => {
...
function M(e) {
  let t;
  const n = x(e), r = { duplex: "half", method: e.method, headers: e.headers };
...
function U(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: M(e), url: x(e) }, e.web.request;
}
function I() {
  return C();
}
...
function W(e) {
  return typeof e == "object" && (e instanceof H3Event || (e == null ? undefined : e[E]) instanceof H3Event || (e == null ? undefined : e.__is_event__) === true);
}
function p(e) {
  return function(...t) {
    var n;
    let r = t[0];
    if (W(r)) t[0] = r instanceof H3Event || r.__is_event__ ? r : r[E];
    else {
...
const x = p(getRequestURL), J$1 = p(getResponseStatus), re$1 = p(useSession), B$1 = p(getHeaders), V$1 = p(getRequestWebStream);
function G() {
  var e;
...
const K = { "app_routes_root_tsx--fetchUser_createServerFn_handler": { functionName: "fetchUser_createServerFn_handler", importer: () => import('../build/__root-BvkRr39_.mjs') }, "app_routes_signup_tsx--signupFn_createServerFn_handler": { functionName: "signupFn_createServerFn_handler", importer: () => import('../build/signup-Ds5DQt_1.mjs') }, "app_routes_authed_tsx--loginFn_createServerFn_handler": { functionName: "loginFn_createServerFn_handler", importer: () => import('../build/_authed-DjZlbL7q.mjs') }, "app_routes_logout_tsx--logoutFn_createServerFn_handler": { functionName: "logoutFn_createServerFn_handler", importer: () => import('../build/logout-CNxee-Uy.mjs') }, "app_utils_posts_ts--fetchPost_createServerFn_handler": { functionName: "fetchPost_createServerFn_handler", importer: () => import('../build/posts-CQVEsRfk.mjs') }, "app_utils_posts_ts--fetchPosts_createServerFn_handler": { functionName: "fetchPosts_createServerFn_handler", importer: () => import('../build/posts-CQVEsRfk.mjs') } }, oe = eventHandler(Q), m = K;
async function Q(e) {
  const t = U(e), n = await Y(t);
  return Object.entries(B$1()).forEach(([r, o]) => {
...
async function Y(e, t) {
  const n = e.method, r = new URL(e.url, "http://localhost:3000"), o = new RegExp(`${X("/_server")}/([^/?#]+)`), c = r.pathname.match(o), a = c ? c[1] : null, w = Object.fromEntries(r.searchParams.entries());
  if (typeof a != "string") throw new Error("Invalid server action param for serverFnId: " + a);
  const g = m[a];
  if (!g) throw console.log("serverFnManifest", m), new Error("Server function info not found for " + a);
  let d;
  if (d = await g.importer(), !d) throw console.log("serverFnManifest", m), new Error("Server function module not resolved for " + a);
  const S = d[g.functionName];
  if (!S) throw console.log("serverFnManifest", m), console.log("fnModule", d), new Error(`Server function module export not resolved for serverFn ID: ${a}`);
  const T = ["multipart/form-data", "application/x-www-form-urlencoded"], _ = await (async () => {
    try {
      const s = await (async () => {
        if (e.headers.get("Content-Type") && T.some((A) => {
          var F;
          return (F = e.headers.get("Content-Type")) == null ? void 0 : F.includes(A);
        })) return N$1(n.toLowerCase() !== "get", "GET requests with FormData payloads are not supported"), await e.formData();
        if (n.toLowerCase() === "get") return w.payload ? f.parse(w.payload) : void 0;
        const O = await e.text();
        return f.parse(O);
      })(), i = await S(s);
      return i instanceof Response ? i : isPlainObject$1(i) && "result" in i && i.result instanceof Response ? i.result : isRedirect$1(i) || isNotFound(i) ? b$1(i) : new Response(i !== void 0 ? f.stringify(i) : void 0, { status: J$1(C()), headers: { "Content-Type": "application/json" } });
    } catch (s) {
      return s instanceof Response ? s : isPlainObject$1(s) && "result" in s && s.result instanceof Response ? s.result : isRedirect$1(s) || isNotFound(s) ? b$1(s) : (console.error("Server Fn Error!"), console.error(s), console.info(), new Response(f.stringify(s), { status: 500, headers: { "Content-Type": "application/json" } }));
    }
  })();
  if (_.headers.get("Content-Type") === "application/json") {
    const i = await _.clone().text();
...
function ce({ tag: e, attrs: t, children: r }) {
  switch (e) {
    case "title":
...
const qe = [], y = { stringify: (e) => JSON.stringify(e, function(r, n) {
  const s = this[r], o = N.find((a) => a.stringifyCondition(s));
  return o ? o.stringify(s) : n;
}), parse: (e) => JSON.parse(e, function(r, n) {
  const s = this[r];
  if (isPlainObject$1(s)) {
    const o = N.find((a) => a.parseCondition(s));
  ...
  const t = N.find((r) => r.stringifyCondition(e));
  return t ? t.stringify(e) : e;
}, decode: (e) => {
  if (isPlainObject$1(e)) {
    const t = N.find((r) => r.parseCondition(e));
    if (t) return t.parse(e);
  }
  return Array.isArray(e) ? e.map((t) => y.decode(t)) : isPlainObject$1(e) ? Object.fromEntries(Object.entries(e).map(([t, r]) => [t, y.decode(r)])) : e;
} }, k = (e, t, r, n) => ({ key: e, stringifyCondition: t, stringify: (s) => ({ [`$${e}`]: r(s) }), parseCondition: (s) => Object.hasOwn(s, `$${e}`), parse: (s) => n(s[`$${e}`]) }), N = [k("undefined", (e) => e === undefined, () => 0, () => {
}), k("date", (e) => e instanceof Date, (e) => e.toISOString(), (e) => new Date(e)), k("error", (e) => e instanceof Error, (e) => ({ ...e, message: e.message, stack: undefined, cause: e.cause }), (e) => Object.assign(new Error(e.message), e)), k("formData", (e) => e instanceof FormData, (e) => {
  const t = {};
...
function $(e, t) {
  const r = t || e || {};
  return typeof r.method > "u" && (r.method = "GET"), { options: r, middleware: (n) => $(undefined, Object.assign(r, { middleware: n })), validator: (n) => $(undefined, Object.assign(r, { validator: n })), handler: (...n) => {
    const [s, o] = n;
    Object.assign(r, { ...s, extractedFn: s, serverFn: o }), s.url || (console.warn(s), warning(false, "createServerFn must be called with a function that has a 'url' property. Ensure that the @tanstack/start-plugin is ordered **before** the @tanstack/server-functions-plugin."));
    const a = [...r.middleware || [], Ke(r)];
    return Object.assign(async (d) => re(a, "client", { ...s, method: r.method, data: d == null ? undefined : d.data, headers: d == null ? undefined : d.headers, context: {} }).then((i) => {
      if (i.error) throw i.error;
      return i.result;
    }), { ...s, __executeServer: async (d) => {
      const i = d instanceof FormData ? Je(d) : d;
      return await re(a, "server", { ...s, ...i }).then((l) => ({ result: l.result, error: l.error, context: l.sendContext }));
    } });
  } };
}
function Je(e) {
...
const te = async (e, t, r) => e({ ...t, next: async (n = {}) => {
  var _a, _b;
  return r({ ...t, ...n, context: { ...t.context, ...n.context }, sendContext: { ...t.sendContext, ...(_a = n.sendContext) != null ? _a : {} }, headers: O(t.headers, n.headers), result: n.result !== undefined ? n.result : t.result, error: (_b = n.error) != null ? _b : t.error });
} });
function Ge(e, t) {
  if (e == null) return {};
  if ("~standard" in e) {
...
async function re(e, t, r) {
  const n = Ve([...qe, ...e]), s = async (o) => {
    const a = n.shift();
    if (!a) return o;
    a.options.validator && (t !== "client" || a.options.validateClient) && (o.data = await Ge(a.options.validator, o.data));
    const d = t === "client" ? a.options.client : a.options.server;
    return d ? te(d, o, async (i) => {
...
function Ke(e) {
  return { _types: undefined, options: { validator: e.validator, validateClient: e.validateClient, client: async ({ next: t, sendContext: r, ...n }) => {
    var s;
    const o = await ((s = e.extractedFn) == null ? undefined : s.call(e, { ...n, context: r }));
    return t(o);
  }, server: async ({ next: t, ...r }) => {
    var n;
    const s = await ((n = e.serverFn) == null ? undefined : n.call(e, r));
    return t({ ...r, result: s });
  } } };
}
const Xe = () => {
  const e = useRouter(), t = useRouterState({ select: (o) => o.matches.map((a) => a.meta).filter(Boolean) }), r = R.useMemo(() => {
    const o = [], a = {};
    let d;
    return [...t].reverse().forEach((i) => {
      [...i].reverse().forEach((u) => {
        var _a;
        if (u) if (u.title) d || (d = { tag: "title", children: u.title });
        else {
          ...
          o.push({ tag: "meta", attrs: { ...u } });
        }
      });
    }), d && o.push(d), o.reverse(), o;
  }, [t]), n = useRouterState({ select: (o) => o.matches.map((a) => a.links).filter(Boolean).flat(1).map((a) => ({ tag: "link", attrs: { ...a } })), structuralSharing: true }), s = useRouterState({ select: (o) => {
    const a = [];
    return o.matches.map((d) => e.looseRoutesById[d.routeId]).forEach((d) => {
      var i, u, l, f;
      return (f = (l = (u = (i = e.ssr) == null ? undefined : i.manifest) == null ? undefined : u.routes[d.id]) == null ? undefined : l.preloads) == null ? undefined : f.filter(Boolean).forEach((h) => {
        a.push({ tag: "link", attrs: { rel: "modulepreload", href: h } });
      });
    }), a;
  }, structuralSharing: true });
  return Qe([...r, ...s, ...n], (o) => JSON.stringify(o));
}, Ye = () => {
  const e = Xe();
  return jsx(Fragment, { children: e.map((t) => createElement(ce, { ...t, key: `tsr-meta-${JSON.stringify(t)}` })) });
}, Ze = () => jsx(Fragment, { children: Ye() });
function Qe(e, t) {
...
const et = () => {
  const e = useRouter(), t = useRouterState({ select: (s) => {
    var o;
    const a = [], d = (o = e.ssr) == null ? undefined : o.manifest;
    return d ? (s.matches.map((i) => e.looseRoutesById[i.routeId]).forEach((i) => {
      var u, l;
      return (l = (u = d.routes[i.id]) == null ? undefined : u.assets) == null ? undefined : l.filter((f) => f.tag === "script").forEach((f) => {
        a.push({ tag: "script", attrs: f.attrs, children: f.children });
      });
    }), a) : (warning(false, "<Scripts /> found no manifest"), []);
  }, structuralSharing: true }), { scripts: r } = useRouterState({ select: (s) => ({ scripts: s.matches.map((o) => o.scripts).flat(1).filter(Boolean).map(({ children: o, ...a }) => ({ tag: "script", attrs: { ...a, suppressHydrationWarning: true }, children: o })) }) }), n = [...r, ...t];
  return jsx(Fragment, { children: n.map((s, o) => createElement(ce, { ...s, key: `tsr-scripts-${s.tag}-${o}` })) });
};
function tt(e) {
  const t = useRouter();
  return async (...r) => {
    try {
      const n = await e(...r);
      if (isRedirect$1(n)) throw n;
      return n;
    } catch (n) {
      if (isRedirect$1(n)) {
        const s = t.resolveRedirect({ ...n, _fromLocation: t.state.location });
        return t.navigate(s);
      }
      throw n;
    }
...
function nt(e, t) {
  e.ssr = { manifest: t, serializer: y }, e.serverSsr = { injectedHtml: [], streamedKeys: /* @__PURE__ */ new Set(), injectHtml: (r) => {
    ...
    warning(!e.serverSsr.streamedKeys.has(r), "Key has already been streamed: " + r), e.serverSsr.streamedKeys.add(r), e.serverSsr.injectScript(() => `__TSR_SSR__.streamedValues['${r}'] = { value: ${T(e.ssr.serializer.stringify(n), { isScriptContext: true, wrap: true, json: true })}}`);
  }, onMatchSettled: at }, e.serverSsr.injectScript(() => rt, { logScript: false });
}
function st(e) {
  var t, r;
  const n = { manifest: e.ssr.manifest, dehydratedData: (r = (t = e.options).dehydrate) == null ? undefined : r.call(t) };
  e.serverSsr.injectScript(() => `__TSR_SSR__.dehydrated = ${T(e.ssr.serializer.stringify(n), { isScriptContext: true, wrap: true, json: true })}`);
}
function ot(e, t) {
  const r = [];
  return { replaced: B(e, (s, o) => {
    if (s instanceof ReadableStream) {
      const [a, d] = s.tee(), i = { type: "stream", path: o, id: r.length, matchIndex: t.match.index, stream: d };
      return r.push(i), a;
    } else if (s instanceof Promise) {
      const a = defer$1(s), d = { type: "promise", path: o, id: r.length, matchIndex: t.match.index, promise: a };
      r.push(d);
    }
    return s;
  }), extracted: r };
...
function at(e) {
  ...
  if (r.loaderData !== undefined) {
    const i = ot(r.loaderData, { match: r });
    r.loaderData = i.replaced, n = i.extracted, s = n.reduce((u, l) => z(u, ["temp", ...l.path], undefined), { temp: i.replaced }).temp;
  }
  const o = `__TSR_SSR__.initMatch(${T({ id: r.id, __beforeLoadContext: t.ssr.serializer.stringify(r.__beforeLoadContext), loaderData: t.ssr.serializer.stringify(s), error: t.ssr.serializer.stringify(r.error), extracted: n == null ? undefined : n.map((i) => pick(i, ["type", "path"])), updatedAt: r.updatedAt, status: r.status }, { isScriptContext: true, wrap: true, json: true })})`;
  t.serverSsr.injectScript(() => o), n && n.forEach((i) => i.type === "promise" ? a(i) : d(i));
  function a(i) {
    t.serverSsr.injectScript(async () => (await i.promise, `__TSR_SSR__.resolvePromise(${T({ matchId: r.id, id: i.id, promiseState: i.promise[TSR_DEFERRED_PROMISE] }, { isScriptContext: true, wrap: true, json: true })})`));
  }
  function d(i) {
    t.serverSsr.injectHtml(async () => {
      try {
        ...
        for (; !(l = await u.read()).done; ) if (l.value) {
          const f = `__TSR_SSR__.injectChunk(${T({ matchId: r.id, id: i.id, chunk: l.value }, { isScriptContext: true, wrap: true, json: true })})`;
          t.serverSsr.injectScript(() => f);
        }
        t.serverSsr.injectScript(() => `__TSR_SSR__.closeStream(${T({ matchId: r.id, id: i.id }, { isScriptContext: true, wrap: true, json: true })})`);
      } catch (u) {
...
function z(e, t, r) {
  ...
  const [n, ...s] = t;
  return Array.isArray(e) ? e.map((o, a) => a === Number(n) ? z(o, s, r) : o) : isPlainObject$1(e) ? { ...e, [n]: z(e[n], s, r) } : e;
}
function B(e, t, r = []) {
  if (isPlainArray(e)) return e.map((s, o) => B(s, t, [...r, `${o}`]));
  if (isPlainObject$1(e)) {
    const s = {};
    for (const o in e) s[o] = B(e[o], t, [...r, o]);
    return s;
  }
  const n = t(e, r);
  return n !== e ? n : e;
...
function it({ createRouter: e, getRouterManifest: t }) {
  return (r) => eventHandler(async (n) => {
    const s = toWebRequest(n), o = new URL(s.url), a = o.href.replace(o.origin, ""), d = createMemoryHistory({ initialEntries: [a] }), i = e();
    nt(i, t == null ? undefined : t()), i.update({ history: d }), await i.load(), st(i);
    const u = ct({ event: n, router: i });
    return await r({ request: s, router: i, responseHeaders: u });
  });
}
function ct(e) {
  e.event.__tsrHeadersSent = true;
  let t = O(getResponseHeaders(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: r } = e.router.state;
  return r && (t = O(t, r.headers, { Location: r.href })), t;
}
function dt(e, t) {
  return de(e, t);
}
function lt(e, t) {
  return Readable$1.fromWeb(de(e, Readable$1.toWeb(t)));
}
const ut = /(<body)/, pt = /(<\/body>)/, ft = /(<\/html>)/, ht = /(<head.*?>)/, mt = /(<\/[a-zA-Z][\w:.-]*?>)/g, gt = new TextDecoder();
function yt() {
  let e;
...
async function St(e, t) {
  ...
  try {
    const o = e.getReader();
    let a;
    for (; !(a = await o.read()).done; ) (r = t.onData) == null || r.call(t, a);
...
function de(e, t) {
  const r = yt();
  let n = true, s = "", o = "", a = false, d = false, i = "", u = "";
  function l() {
    const p = s;
    return s = "", p;
  }
  function f(p) {
    return p instanceof Uint8Array ? gt.decode(p) : String(p);
  }
  ...
  const we = e.subscribe("onInjectedHtml", (p) => {
    G(p.promise);
  });
  function G(p) {
    S++, p.then((j) => {
  ...
  return h.then(() => {
    ...
    const j = f(p.value);
    let m = i + j;
    const M = m.match(pt), K = m.match(ft);
    if (a || m.match(ut) && (a = true), !d) {
      const _ = m.match(ht);
      if (_) {
        d = true;
        const X = _.index, Y = _[0], Re = m.slice(X + Y.length);
        r.write(m.slice(0, X) + Y + l()), m = Re;
      }
    }
    if (!a) {
      r.write(m), i = "";
    ...
    if (M && K && M.index < K.index) {
      const _ = M.index;
      o = m.slice(_), r.write(m.slice(0, _) + l()), i = "";
      return;
    }
    let D, A = 0;
    for (; (D = mt.exec(m)) !== null; ) A = D.index + D[0].length;
    if (A > 0) {
      const _ = m.slice(0, A) + l() + u;
      r.write(_), i = m.slice(A);
    } else i = m, u += l();
  }, onEnd: () => {
    n = false, S === 0 && h.resolve();
  }, onError: (p) => {
    console.error("Error reading appStream:", p), r.destroy(p);
  } }), r.stream;
}
const _t = async ({ request: e, router: t, responseHeaders: r }) => {
  if (typeof H$1.renderToReadableStream == "function") {
    const n = await H$1.renderToReadableStream(jsx(ee, { router: t }), { signal: e.signal });
    isbot(e.headers.get("User-Agent")) && await n.allReady;
    const s = dt(t, n);
    return new Response(s, { status: t.state.statusCode, headers: r });
  }
  if (typeof H$1.renderToPipeableStream == "function") {
    const n = new PassThrough();
    try {
      const o = H$1.renderToPipeableStream(jsx(ee, { router: t }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
        o.pipe(n);
      } } : { onShellReady() {
        o.pipe(n);
      } }, onError: (a, d) => {
...
const le = Symbol("$HTTPEvent");
function Rt(e) {
  return typeof e == "object" && (e instanceof H3Event || (e == null ? undefined : e[le]) instanceof H3Event || (e == null ? undefined : e.__is_event__) === true);
}
function xt(e) {
  return function(...t) {
    var r;
    let n = t[0];
    if (Rt(n)) t[0] = n instanceof H3Event || n.__is_event__ ? n : n[le];
    else {
...
const Ct = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/", "/_authed", "/login", "/logout", "/signup"], preloads: ["/_build/assets/client-CwqYvT_U.js", "/_build/assets/client-DgwULqby.js"] }, "/": { filePath: "index.tsx" }, "/_authed": { filePath: "_authed.tsx", children: ["/_authed/posts"] }, "/login": { filePath: "login.tsx" }, "/logout": { filePath: "logout.tsx" }, "/signup": { filePath: "signup.tsx" }, "/_authed/posts": { filePath: "_authed/posts.tsx", parent: "/_authed", children: ["/_authed/posts/$postId", "/_authed/posts/"] }, "/_authed/posts/$postId": { filePath: "_authed/posts.$postId.tsx", parent: "/_authed/posts" }, "/_authed/posts/": { filePath: "_authed/posts.index.tsx", parent: "/_authed/posts" } } });
function Et(e) {
...
async function Ft(e, t, r) {
  ...
  if (isPlainObject$1(s) && s.method) {
    const d = s, i = d.data instanceof FormData ? "formData" : "payload", u = new Headers({ ...i === "payload" ? { "content-type": "application/json", accept: "application/json" } : {}, ...d.headers instanceof Headers ? Object.fromEntries(d.headers.entries()) : d.headers });
    if (d.method === "GET") {
      const h = encode$1({ payload: y.stringify({ data: d.data, context: d.context }) });
      h && (e.includes("?") ? e += `&${h}` : e += `?${h}`);
    }
    const l = await r(e, { method: d.method, headers: u, ...jt(d) }), f = await ne(l);
  ...
  const o = await ne(await r(e, { method: "POST", headers: { Accept: "application/json", "Content-Type": "application/json" }, body: JSON.stringify(t) })), a = o.headers.get("content-type");
  return a && a.includes("application/json") ? y.decode(await o.json()) : o.text();
}
function jt(e) {
  var _a;
...
const q = (e, t) => {
  const r = `/${At(t)}/${e}`;
  return Object.assign((...s) => Ft(r, s, async (o, a) => (a.headers = O(vt(), a.headers), $fetch.native(o, a))), { url: r, functionId: e });
};
function ue({ error: e }) {
...
const Ht = "/_build/assets/app-DsP6hc0w.css", kt = ({ title: e, description: t, keywords: r, image: n }) => [{ title: e }, { name: "description", content: t }, { name: "keywords", content: r }, { name: "twitter:title", content: e }, { name: "twitter:description", content: t }, { name: "twitter:creator", content: "@tannerlinsley" }, { name: "twitter:site", content: "@tannerlinsley" }, { name: "og:type", content: "website" }, { name: "og:title", content: e }, { name: "og:description", content: t }, ...n ? [{ name: "twitter:image", content: n }, { name: "twitter:card", content: "summary_large_image" }, { name: "og:image", content: n }] : []], Nt = q("app_routes_root_tsx--fetchUser_createServerFn_handler", "/_server"), It = $({ method: "GET" }).handler(Nt), b = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, ...kt({ title: "TanStack Start | Type-Safe, Client-First, Full-Stack React Framework", description: "TanStack Start is a type-safe, client-first, full-stack React framework. " })], links: [{ rel: "stylesheet", href: Ht }, { rel: "apple-touch-icon", sizes: "180x180", href: "/apple-touch-icon.png" }, { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32x32.png" }, { rel: "icon", type: "image/png", sizes: "16x16", href: "/favicon-16x16.png" }, { rel: "manifest", href: "/site.webmanifest", color: "#fffff" }, { rel: "icon", href: "/favicon.ico" }] }), beforeLoad: async () => ({ user: await It() }), errorComponent: (e) => jsx(pe, { children: jsx(ue, { ...e }) }), notFoundComponent: () => jsx(J, {}), component: Ot });
function Ot() {
  return jsx(pe, { children: jsx(Outlet, {}) });
}
function pe({ children: e }) {
  const { user: t } = b.useRouteContext();
  return jsxs("html", { children: [jsx("head", { children: jsx(Ze, {}) }), jsxs("body", { children: [jsxs("div", { className: "p-2 flex gap-2 text-lg", children: [jsx(Link, { to: "/", activeProps: { className: "font-bold" }, activeOptions: { exact: true }, children: "Home" }), " ", jsx(Link, { to: "/posts", activeProps: { className: "font-bold" }, children: "Posts" }), jsx("div", { className: "ml-auto", children: t ? jsxs(Fragment, { children: [jsx("span", { className: "mr-2", children: t.email }), jsx(Link, { to: "/logout", children: "Logout" })] }) : jsx(Link, { to: "/login", children: "Login" }) })] }), jsx("hr", {}), e, jsx(TanStackRouterDevtools, { position: "bottom-right" }), jsx(et, {})] })] });
}
const Mt = () => import('../build/signup-CfKMAOQ9.mjs'), Dt = q("app_routes_signup_tsx--signupFn_createServerFn_handler", "/_server"), Lt = $({ method: "POST" }).validator((e) => e).handler(Dt), fe = createFileRoute("/signup")({ component: lazyRouteComponent(Mt, "component", () => fe.ssr) }), zt = () => import('../build/logout-EquEDiL3.mjs'), Bt = createFileRoute("/logout")({ preload: false, loader: lazyFn(zt, "loader") }), Wt = () => import('../build/login-0uWw0H6G.mjs'), he = createFileRoute("/login")({ component: lazyRouteComponent(Wt, "component", () => he.ssr) });
function se(e) {
  const [t, r] = R.useState(), [n, s] = R.useState(), [o, a] = R.useState(), [d, i] = R.useState(), [u, l] = R.useState("idle"), f = R.useCallback(async (h) => {
    var _a;
    l("pending"), r(Date.now()), s(h);
    try {
      const S = await e.fn(h);
      return await ((_a = e.onSuccess) == null ? void 0 : _a.call(e, { data: S })), l("success"), a(void 0), i(S), S;
    } catch (S) {
      l("error"), a(S);
    }
  }, [e.fn]);
  return { status: u, variables: n, submittedAt: t, mutate: f, error: o, data: d };
}
function Ut({ actionText: e, onSubmit: t, status: r, afterSubmit: n }) {
  return jsx("div", { className: "fixed inset-0 bg-white dark:bg-black flex items-start justify-center p-8", children: jsxs("div", { className: "bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg", children: [jsx("h1", { className: "text-2xl font-bold mb-4", children: e }), jsxs("form", { onSubmit: (s) => {
    s.preventDefault(), t(s);
  }, className: "space-y-4", children: [jsxs("div", { children: [jsx("label", { htmlFor: "email", className: "block text-xs", children: "Username" }), jsx("input", { type: "email", name: "email", id: "email", className: "px-2 py-1 w-full rounded border border-gray-500/20 bg-white dark:bg-gray-800" })] }), jsxs("div", { children: [jsx("label", { htmlFor: "password", className: "block text-xs", children: "Password" }), jsx("input", { type: "password", name: "password", id: "password", className: "px-2 py-1 w-full rounded border border-gray-500/20 bg-white dark:bg-gray-800" })] }), jsx("button", { type: "submit", className: "w-full bg-cyan-600 text-white rounded py-2 font-black uppercase", disabled: r === "pending", children: r === "pending" ? "..." : e }), n || null] })] }) });
}
function qt() {
  const e = useRouter(), t = se({ fn: Vt, onSuccess: async (n) => {
    var _a;
    if (!((_a = n.data) == null ? undefined : _a.error)) {
      await e.invalidate(), e.navigate({ to: "/" });
      return;
    }
  } }), r = se({ fn: tt(Lt) });
  return jsx(Ut, { actionText: "Login", status: t.status, onSubmit: (n) => {
    const s = new FormData(n.target);
    t.mutate({ data: { email: s.get("email"), password: s.get("password") } });
  }, afterSubmit: t.data ? jsxs(Fragment, { children: [jsx("div", { className: "text-red-400", children: t.data.message }), t.data.userNotFound ? jsx("div", { children: jsx("button", { className: "text-blue-500", onClick: (n) => {
    const s = new FormData(n.target.form);
    r.mutate({ data: { email: s.get("email"), password: s.get("password") } });
  }, type: "button", children: "Sign up instead?" }) }) : null] }) : null });
}
const Jt = q("app_routes_authed_tsx--loginFn_createServerFn_handler", "/_server"), Vt = $({ method: "POST" }).validator((e) => e).handler(Jt), Gt = createFileRoute("/_authed")({ beforeLoad: ({ context: e }) => {
  if (!e.user) throw new Error("Not authenticated");
}, errorComponent: ({ error: e }) => {
  if (e.message === "Not authenticated") return jsx(qt, {});
  throw e;
} }), Kt = () => import('../build/index-CuMTP0jl.mjs'), me = createFileRoute("/")({ component: lazyRouteComponent(Kt, "component", () => me.ssr) }), Xt = () => import('../build/posts--TqO-k-0.mjs'), Yt = () => import('../build/posts--TqO-k-0.mjs'), ge = createFileRoute("/_authed/posts")({ loader: lazyFn(Yt, "loader"), component: lazyRouteComponent(Xt, "component", () => ge.ssr) }), Zt = () => import('../build/posts.index-GrcD0GTd.mjs'), ye = createFileRoute("/_authed/posts/")({ component: lazyRouteComponent(Zt, "component", () => ye.ssr) }), Qt = () => import('../build/posts._postId-DekZoZAw.mjs'), er = () => import('../build/posts._postId-DekZoZAw.mjs'), Se = createFileRoute("/_authed/posts/$postId")({ loader: lazyFn(er, "loader"), errorComponent: tr, component: lazyRouteComponent(Qt, "component", () => Se.ssr), notFoundComponent: () => jsx(J, { children: "Post not found" }) });
function tr({ error: e }) {
  return jsx(ErrorComponent, { error: e });
}
const rr = fe.update({ id: "/signup", path: "/signup", getParentRoute: () => b }), nr = Bt.update({ id: "/logout", path: "/logout", getParentRoute: () => b }), sr = he.update({ id: "/login", path: "/login", getParentRoute: () => b }), _e = Gt.update({ id: "/_authed", getParentRoute: () => b }), or = me.update({ id: "/", path: "/", getParentRoute: () => b }), V = ge.update({ id: "/posts", path: "/posts", getParentRoute: () => _e }), ar = ye.update({ id: "/", path: "/", getParentRoute: () => V }), ir = Se.update({ id: "/$postId", path: "/$postId", getParentRoute: () => V }), cr = { AuthedPostsPostIdRoute: ir, AuthedPostsIndexRoute: ar }, dr = V._addFileChildren(cr), lr = { AuthedPostsRoute: dr }, ur = _e._addFileChildren(lr), pr = { IndexRoute: or, AuthedRoute: ur, LoginRoute: sr, LogoutRoute: nr, SignupRoute: rr }, fr = b._addFileChildren(pr)._addFileTypes();
function hr() {
  return createRouter$2({ routeTree: fr, defaultPreload: "intent", defaultErrorComponent: ue, defaultNotFoundComponent: () => jsx(J, {}), scrollRestoration: true });
}
const Er = it({ createRouter: hr, getRouterManifest: Pt })(_t);
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/joe.barnett/dev/personal/basic-auth/.data/kv"}));
...
export { $, Lt as L, Se as S, Ut as U, qt as a, f, ge as g, handler as h, node$1 as n, q, re$1 as r, se as s, tt as t };
